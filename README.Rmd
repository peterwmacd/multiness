...
"multiness" includes an example multiplex network of agricultural trade which is studied in [MacDonald et al., (2020)](https://arxiv.org/abs/2012.14409). It is easy to import and to fit a Gaussian MultiNeSS model with adaptive tuning. 
